...
class SendEmail:
    ...
    def __init__(self, conn_param, use_TLS=True):
        ...
        try:
            ...
            return("The server didn't accept the username/password combination provided \
    ...
    def send(self, to_address, from_name=None, cc_address=None, \
        ...
        if not self.is_ok:
            return("Message sending failed. Connection not found.")
        else: 
            ...
            if not self.check_mail_address(to_address) or \
                ...
                return ("Email address is not in required format and/or is invalid.")
            ...
            if attachments: 
                if isinstance(attachments, list):
                    ...
                    return ("Attachments are provided in an invalid format.")
            
            # send the message via the server set up earlier.
            try:
                self.smtp_conn.send_message(msg)
            except smtplib.SMTPSenderRefused:
                return ("Your message exceeded allowed message size limits.\
...
def main():           
    ...
    """
    send_email = SendEmail(['smtp.gmail.com', 587, 'sokratis.email@gmail.com', 'iloveyousokratis1234'])
    send_email.send(to_address=['zeeshanraul11@gmail.com'],attachments=["/root/filemanager/filemanager/fm/img.jpg"])
